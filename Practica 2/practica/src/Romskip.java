...
public class Romskip {
	...
	//Embarca una mercancia en la nave - funciona
	...
	//Desembarca una mercancia de la bodega
	...
	//Teletransporta una mercancia a otra romskip
	...
	//verifica que se puede teletransportar dicha mercancia a otra romskip
	...
	//numero de espacios en la bodega
	public int conteo(){
		int devolucion=0;
	...
	//return nombre de la romskip
	public String getNombre(){
		return nombre;
	}
	
	
	//return length de la bodega
	public int getBodegaLength(){
		int devolucion;
		devolucion=bodega.length;
	...
	//devuelve el peso actual de la nave, sumando todos sus mercancias
	...
	//return de la galaxia
	public static Galaxia getGalaxia(){
		return mapa;
	}
}
