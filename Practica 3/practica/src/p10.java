 ...
 * come para todas las posiciones de su array de energía. Se invoca
 * nivelEnergetico. Se invoca interacciona de manera que accede a todas las
 * posiciones de su array de energía y a algunas no correctas. Se invoca
 * nivelEnergetico.
 * 
 * @author Nedyar
 */
public class p10 {
	public static void main(String[] args) {
		...
		for (int i = 0; i <= rau.getEnergia().length*9; i+=9) {
